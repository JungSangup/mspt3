...
[15.md]
- [ ] 후속 과정에서 헬름 차트를 사용하는 방식을 고려하여 필요한 이론, 실습 내용이 보완되었으면 합니다 ( [2주차(Outer Architecture)](https://github.com/mspt2/MSP-pjt-2w/blob/main/2w(Outer%20Architecture).md) 참조 ) 
