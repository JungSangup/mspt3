...
Control-plane node에서 다음과 같이 확입합니다.  
```bash
$ kubectl cluster-info
Kubernetes control plane is running at https://172.31.29.238:6443
CoreDNS is running at https://172.31.29.238:6443/api/v1/namespaces/kube-system/services/kube-dns:dns/proxy
...
gk5fqk.r7o1g...   21h         2024-01-16T05:07:18Z   authentication,signing   The default bootstrap token generated by 'kubeadm init'.   system:bootstrappers:kubeadm:default-node-token
```
